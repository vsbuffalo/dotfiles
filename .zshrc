...
export PATH=/usr/local/bin:/usr/texbin:/usr/bin:/bin:/usr/local/sbin:/usr/sbin:/sbin:/usr/local/bin:/opt/X13/bin:~/.cabal/bin:/Users/vinceb/.gem/ruby/2.0.0/bin:/usr/local/texlive/2016basic/bin/x86_64-darwin/
alias ll="ls -larth"
alias -s txt=less
alias df="df -h"
alias du="du -h"
